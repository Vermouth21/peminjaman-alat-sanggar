                                ...
                                <table>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                            	<a href="uploadbukti.php?id=<?php echo $id_booking; ?>" style="border: 2px solid gray;background-color: #0000ff;padding: 5px 10px; font-size: 15px;color: white;border-radius: 8px;">Konfirmasi</a>
                                            </td>
                                        </tr>
                                        <?php } } ?>
                                    </tbody>
