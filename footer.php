						...
						<div class="col-lg-12">
							<div class="footer__widget footer__menu">
								<div class="ft__logo">
									...
									<p>Sanggar Seni Sabai Nan Aluih Merupakan Sanggar Yang Bergerak Dibidang Penyewaan Busana Tari Dan Tarian. </p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-lg-6 col-md-6 col-sm-12">
							<div class="copyright">
								<div class="copy__right__inner text-left">
									<p>Copyright <i class="fa fa-copyright"></i><?php echo date("Y"); ?> Devisri</a> All Rights Reserved</p>
								</div>
							</div>
						</div>
