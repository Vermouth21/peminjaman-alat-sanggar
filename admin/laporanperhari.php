...
<!--body wrapper start-->
	<div class="wrapper">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="white-box">
                    <form class="form-horizontal" action="cetak_perhari.php" method="post">
                        <div class="form-group">
                            <label class="col-sm-3 control-label">Tanggal</label>
                            <div class="col-sm-5">
                                <select class="form-control input-sm m-b-15" name="tanggal">
                                    <option value="0" selected>-- Pilih Tanggal --</option>
                                    <?php
                                        include "koneksi.php";
                                        $q  = "select DISTINCT tgl from transaksi";
